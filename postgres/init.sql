...
-- Started on 2023-05-16 19:40:55
...
--
-- TOC entry 252 (class 1255 OID 50889)
-- Name: swap_roles(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.swap_roles(p_user integer, p_role integer) RETURNS integer
    LANGUAGE plpgsql
    AS $_$
	DECLARE tempid int;
begin
	...
	set
	roles_id=$2
	where employee_id = $1 returning id_user into tempid;
	return tempid;
end;
$_$;


ALTER FUNCTION public.swap_roles(p_user integer, p_role integer) OWNER TO postgres;
...
2	test	646667686a6b776567686b6a68666761484a303938424840bd001563085fc35165329ea1ff5c5ecbdbbeef	60	3
\.
...
--
-- TOC entry 2957 (class 2606 OID 50891)
...
-- Completed on 2023-05-16 19:40:56
